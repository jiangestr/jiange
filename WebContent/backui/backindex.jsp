...
<body style="background-color: #f2f9fd;">
	<div class="header bg-main">
		...
		<div class="head-l">
			<a class="button button-little bg-green"
				href="${pageContext.request.contextPath }/index.jsp" target="_blank"><span
	...
	<div class="leftnav">
		...
		<ul style="display: block">
			<li><a
				href="<%=request.getContextPath() %>/com.jiange.servlet/AlertCarServlet?action=showCars&limit=0"
				target="right"><span class="icon-caret-right"></span>车辆修改</a></li>
			<li><a
				href="<%=request.getContextPath() %>/com.jiange.servlet/AlertCarServlet?action=showadd"
				target="right"><span class="icon-caret-right"></span>车辆添加</a></li>
			<li><a
				href="<%=request.getContextPath() %>/com.jiange.servlet/AlterOrderServlet?action=showOrders&limit=0"
				target="right"><span class="icon-caret-right"></span>订单修改</a></li>
  ...
  $(".leftnav ul li a").click(function(){
	...
	<div class="admin">
		<iframe scrolling="auto" rameborder="0"
			src="${pageContext.request.contextPath }/<%=mainPage %>" name="right"
