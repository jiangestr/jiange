...
<form
	action="<%=request.getContextPath() %>/com.jiange.servlet/AlertCarServlet?action=updateCar"
	method="post">
	<table class="table table-hover table-bordered">
		...
		<tr class="info">
			...
			<td><input type="text" class="form-control" name="type"
				value="<%=car.getType() %>" /></td>
		</tr>
		<tr class="info">
			<td>牌照</td>
			<td><input type="text" class="form-control" name="license"
				value="<%=car.getLicense() %>" /></td>
		</tr>
		<tr class="info">
			<td>载人</td>
			<td><input type="text" class="form-control" name="ride"
				value="<%=car.getRide() %>" /></td>
		</tr>
		<tr class="info">
			<td>载重</td>
			<td><input type="text" class="form-control" name="load"
				value="<%=car.getLoad() %>" /></td>
		</tr>
		<tr class="info">
			<td>价格</td>
